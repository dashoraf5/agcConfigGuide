=================================================================
SaaS Application Configuration Guide : LivePerson
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure LivePerson:
...
LivePerson Configuration in AGC Workflow
----------------------------------------------
...
LivePerson, select
LivePerson and click on **Add** button
...
To configure LivePerson provide following inputs:
	- **ACS URI** : Specify Assertion Consumer Service (ACS) URI provided to you by LivePerson, for example   https://sales.liveperson.net/hc/s-siteId/web/m-LP/samlAssertionMembersArea/home.jsp?lpservice=liveEngage&servicepath=a%2F~~accountid~~%2F%23%2C~~ssokey~~ where siteId and accountId are specific to you account.
...
#. Identify the Saml SSO object created for for LivePerson and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in LivePerson service.
