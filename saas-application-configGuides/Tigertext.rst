=================================================================
SaaS Application Configuration Guide : Tigertext.me
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Tigertext.me:
...
Tigertext.me Configuration in AGC Workflow
----------------------------------------------
...
Tigertext.me, select
Tigertext.me and click on **Add** button
...
To configure Tigertext.me provide following inputs:
	- **Organization Id** : Provide the organization id. For eg - If the SSO URL is https://saml-lb.tigertext.me/v1/organization/abcdefgh01234/saml/consume, then organization id is abcdefgh01234.
...
#. Identify the Saml SSO object created for for Tigertext.me and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Tigertext.me service.
