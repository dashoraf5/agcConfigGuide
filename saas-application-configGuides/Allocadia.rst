=================================================================
SaaS Application Configuration Guide : Allocadia
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Allocadia:
...
Allocadia Configuration in AGC Workflow
----------------------------------------------
...
Allocadia, select
Allocadia and click on **Add** button
...
To configure Allocadia provide following inputs:
	- **SubDomain** : Provide the sub domain name from the SSO URL. For eg - If the URL is https://company.allocadia.com/allocadia/saml/SSO, then the sub domain is company.
...
#. Identify the Saml SSO object created for for Allocadia and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Allocadia service.
