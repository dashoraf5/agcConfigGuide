=================================================================
SaaS Application Configuration Guide : G-Suite
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure G-Suite:
...
G-Suite Configuration in AGC Workflow
----------------------------------------------
...
G-Suite, select
G-Suite and click on **Add** button
...
To configure G-Suite provide following inputs:
	- **Use domain specific issuer** : Select Yes if you have a domain specific issuer.
	- **Domain Name** : Provide your domain name configured in G-suite.
...
#. Identify the Saml SSO object created for for G-Suite and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in G-Suite service.
