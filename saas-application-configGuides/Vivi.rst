=================================================================
SaaS Application Configuration Guide : Vivi
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Vivi:
...
Vivi Configuration in AGC Workflow
----------------------------------------------
...
To configure Vivi provide following inputs:
	- **Unique Organization Id** : Provide your unique organization id. For eg - In the URL - https://api.vivi.io/api/v1/users/saml_metadata/abcd-1234, abcd-1234 is the unique id.
...
#. Identify the Saml SSO object created for for Vivi and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Vivi service.
