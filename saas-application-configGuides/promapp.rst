=================================================================
SaaS Application Configuration Guide : Promapp
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Promapp:
...
Promapp Configuration in AGC Workflow
----------------------------------------------
...
Promapp, select
Promapp and click on **Add** button
...
To configure Promapp provide following inputs:
	- **Tenant Name** : Provide the Tenant Name. For eg if the SSO URL is https://company.promapp.com/tenant/, the Tenant Name is tenant.
	- **Subdomain** : Provide the subDomain. For eg if the SSO URL is https://company.promapp.com/xyz/, the subDomain is company.
...
#. Identify the Saml SSO object created for for Promapp and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Promapp service.
