=================================================================
SaaS Application Configuration Guide : WebDam
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure WebDam:
...
WebDam Configuration in AGC Workflow
----------------------------------------------
...
WebDam, select
WebDam and click on **Add** button
...
To configure WebDam provide following inputs:
	- **Sub-domain** : From your SSO URL like https://company.webdamdb.com/saml.php, the sub-domain is company.
...
#. Identify the Saml SSO object created for for WebDam and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in WebDam service.
