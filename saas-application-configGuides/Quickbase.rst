=================================================================
SaaS Application Configuration Guide : Quickbase
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Quickbase:
...
Quickbase Configuration in AGC Workflow
----------------------------------------------
...
Quickbase, select
Quickbase and click on **Add** button
...
To configure Quickbase provide following inputs:
	- **Sub-Domain** : Provide the subDomain from the SSO URL. For eg - If the SSO URL is https://company.quickbase.com, then sub-domain is company.
...
#. Identify the Saml SSO object created for for Quickbase and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Quickbase service.
