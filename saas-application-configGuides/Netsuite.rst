=================================================================
SaaS Application Configuration Guide : Netsuite
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Netsuite:
...
Netsuite Configuration in AGC Workflow
----------------------------------------------
...
Netsuite, select
Netsuite and click on **Add** button
...
To configure Netsuite provide following inputs:
	- **Endpoint URL Subdomain** : Provide the sub domain from the SSO URL. For eg - If URL is https://system.testcompany.netsuite.com/saml2/acs, then sub domain is testcompany.
	- **Netsuite Account ID** : Provide your netsuite account ID obtained from Netsuite administrator.
...
#. Identify the Saml SSO object created for for Netsuite and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Netsuite service.
