=================================================================
SaaS Application Configuration Guide : Sprinklr
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Sprinklr:
...
Sprinklr Configuration in AGC Workflow
----------------------------------------------
...
Sprinklr, select
Sprinklr and click on **Add** button
...
To configure Sprinklr provide following inputs:
	- **Sub-domain** : Provide the subDomain. For eg - In SSO URL, https://company.sprinklr.com/ui/sso/saml/249, company is the sub-domain
	- **Account Number** : In SSO URL https://company.sprinklr.com/ui/sso/saml/135, 135 is the account number
...
#. Identify the Saml SSO object created for for Sprinklr and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Sprinklr service.
