=================================================================
SaaS Application Configuration Guide : Domo
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Domo:
...
Domo Configuration in AGC Workflow
----------------------------------------------
...
To configure Domo provide following inputs:
	- **Company sub-domain** : Provide the company sub-domain from the SSO URL For eg - In SSO URL https://company.domo.com/auth/saml, company is the sub domain.
...
#. Identify the Saml SSO object created for for Domo and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Domo service.
