=================================================================
SaaS Application Configuration Guide : Blackboard.com
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Blackboard.com:
...
Blackboard.com Configuration in AGC Workflow
----------------------------------------------
...
Blackboard.com, select
Blackboard.com and click on **Add** button
...
To configure Blackboard.com provide following inputs:
	- **SubDomain** : Provide your subdomain name. For eg - In https://company.blackboard.com/, subDomain is company
...
#. Identify the Saml SSO object created for for Blackboard.com and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Blackboard.com service.
