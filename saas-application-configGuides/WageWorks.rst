=================================================================
SaaS Application Configuration Guide : WageWorks
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure WageWorks:
...
WageWorks Configuration in AGC Workflow
----------------------------------------------
...
WageWorks, select
WageWorks and click on **Add** button
...
To configure WageWorks provide following inputs:
	- **Sub Domain** : Enter your Subdomain. For example, if you log into https://acme.wageworks.com/sp/ACS.saml2, enter: acme
	- **ProgramSponsorID** : Please, enter your ProgramSponsorID
...
#. Identify the Saml SSO object created for for WageWorks and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in WageWorks service.
