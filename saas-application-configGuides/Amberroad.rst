=================================================================
SaaS Application Configuration Guide : Amberroad
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Amberroad:
...
Amberroad Configuration in AGC Workflow
----------------------------------------------
...
Amberroad, select
Amberroad and click on **Add** button
...
To configure Amberroad provide following inputs:
	- **Sub Domain** : Provide the sub-domain from SSO URL. For eg - If your SSO URL is https://company.amberroad.com/gtm/ACSServlet, then the sub domain is company
...
#. Identify the Saml SSO object created for for Amberroad and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Amberroad service.
