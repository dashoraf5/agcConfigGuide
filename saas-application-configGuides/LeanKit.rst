=================================================================
SaaS Application Configuration Guide : LeanKit
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure LeanKit:
...
LeanKit Configuration in AGC Workflow
----------------------------------------------
...
LeanKit, select
LeanKit and click on **Add** button
...
To configure LeanKit provide following inputs:
	- **Sub Domain** : From the SSO URL like https://company.leankit.com, subDomain is company
...
#. Identify the Saml SSO object created for for LeanKit and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in LeanKit service.
