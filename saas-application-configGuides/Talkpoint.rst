=================================================================
SaaS Application Configuration Guide : Talkpoint webcasts
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Talkpoint webcasts:
...
Talkpoint webcasts Configuration in AGC Workflow
----------------------------------------------
...
Talkpoint webcasts, select
Talkpoint webcasts and click on **Add** button
...
To configure Talkpoint webcasts provide following inputs:
	- **Relay State/Organization ID** : Provide your organization id.
...
#. Identify the Saml SSO object created for for Talkpoint webcasts and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Talkpoint webcasts service.
