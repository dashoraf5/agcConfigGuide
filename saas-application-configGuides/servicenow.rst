=================================================================
SaaS Application Configuration Guide : ServiceNow
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure ServiceNow:
...
ServiceNow Configuration in AGC Workflow
----------------------------------------------
...
ServiceNow, select
ServiceNow and click on **Add** button
...
To configure ServiceNow provide following inputs:
	- **Domain Name** : Provide your sub domain from the SSO URL. For eg - If the URL is https://company.service-now.com, then sub domain is company.
...
#. Identify the Saml SSO object created for for ServiceNow and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in ServiceNow service.
