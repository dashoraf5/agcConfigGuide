...
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure SAP Successfactors:
...
SAP Successfactors Configuration in AGC Workflow
----------------------------------------------
...
SAP Successfactors, select
SAP Successfactors and click on **Add** button
...
To configure SAP Successfactors provide following inputs:
	...
	- **Relay State** : Provide the relay state if any. Default is /sf/home.
...
#. Identify the Saml SSO object created for for SAP Successfactors and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in SAP Successfactors service.
