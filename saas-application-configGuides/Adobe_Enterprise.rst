=================================================================
SaaS Application Configuration Guide : Adobe Enterprise
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Adobe Enterprise:
...
Adobe Enterprise Configuration in AGC Workflow
----------------------------------------------
...
Adobe Enterprise, select
Adobe Enterprise and click on **Add** button
...
To configure Adobe Enterprise provide following inputs:
	- **EntityId** : Provide Adobe's EntityID URL from the metadata file or Adobe Administrator.
	- **Assertion Consumer Service URI** : Provide Adobe's Assertion Consumer Service URL from the metadata file or Adobe Administrator.
...
#. Identify the Saml SSO object created for for Adobe Enterprise and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Adobe Enterprise service.
