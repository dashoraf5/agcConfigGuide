=================================================================
SaaS Application Configuration Guide : Citrix GoToMeeting
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Citrix GoToMeeting:
...
Citrix GoToMeeting Configuration in AGC Workflow
----------------------------------------------
...
Citrix GoToMeeting, select
Citrix GoToMeeting and click on **Add** button
...
To configure Citrix GoToMeeting provide following inputs:
	- **Relay State** : Relay state varies depending on the product selection.
	- **Select your GoTo Product** : Select the GoTo Product.
...
#. Identify the Saml SSO object created for for Citrix GoToMeeting and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Citrix GoToMeeting service.
