=================================================================
SaaS Application Configuration Guide : Terranova WW Corp
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Terranova WW Corp:
...
Terranova WW Corp Configuration in AGC Workflow
----------------------------------------------
...
Terranova WW Corp, select
Terranova WW Corp and click on **Add** button
...
To configure Terranova WW Corp provide following inputs:
	- **Service UUID** : Specify Service UUID. If your ACS Url is https://secure.terranovasite.com/lms/login/saml2/tnssosp_ACS.aspx?e=1bac98a2-d7b0-46ea-a718-264ac8e77173 then enter 1bac98a2-d7b0-46ea-a718-264ac8e77173 for Service UUDI.
...
#. Identify the Saml SSO object created for for Terranova WW Corp and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Terranova WW Corp service.
