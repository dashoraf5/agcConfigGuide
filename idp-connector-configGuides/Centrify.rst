...
To configure Centrify provide following inputs:
	- **Entity ID / SAML Issuer URL** : Provide the Issuer URL configured in Centrify. The entityId will have a format like https://cloud.centrify.com/SAML/<appspecificName>.
	- **ssoURI** : Provide the SSO URI configured in Centrify. The URL will look like - https://abcd0100.my.centrify.com/applogin/appKey/1234abcde-51c9-461c-a3bf-1234abcde/customerId/abcd0100
