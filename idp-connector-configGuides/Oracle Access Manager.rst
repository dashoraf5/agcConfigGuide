...
To configure Oracle Access Manager provide following inputs:
	- **Domain Name** : Provide the domain name of your IDP from the SSO URI. For eg - If URI is https://example.test.com/oamfed/idp/samlv20, then domain name is example.test.com
