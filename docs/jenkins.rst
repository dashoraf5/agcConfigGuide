=================================================================
SaaS Application Configuration Guide : Jenkins
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Jenkins:
...
Jenkins Configuration in AGC Workflow
----------------------------------------------
...
Jenkins, select
Jenkins and click on **Add** button
...
To configure Jenkins provide following inputs:
	- **Host Name** : Enter your Host Name. For example, if your ACS URL is https://yourcompany.com/securityRealm/finishLogin, enter: yourcompany.com
...
#. Identify the Saml SSO object created for for Jenkins and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Jenkins service.
