=================================================================
SaaS Application Configuration Guide : Planisware
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Planisware:
...
Planisware Configuration in AGC Workflow
----------------------------------------------
...
Planisware, select
Planisware and click on **Add** button
...
To configure Planisware provide following inputs:
	- **Sub Domain** : Specify Sub Domain. If your ACS URI is https://acme.planisware.com:443/sp/ACS.saml2, then enter acme for Sub Domain.
...
#. Identify the Saml SSO object created for for Planisware and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Planisware service.
