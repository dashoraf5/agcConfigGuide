...
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure First Eagle Investment Management:
...
First Eagle Investment Management Configuration in AGC Workflow
----------------------------------------------
...
First Eagle Investment Management, select
First Eagle Investment Management and click on **Add** button
...
To configure First Eagle Investment Management provide following inputs:
	- **Sub Domain Name** : Specify Sub Domain which is used to setup if your entityId, for example, if your entityId is https://acme.feim.com/acme_sp then your subDomain is acme.
...
#. Identify the Saml SSO object created for for First Eagle Investment Management and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in First Eagle Investment Management service.
