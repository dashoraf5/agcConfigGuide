=================================================================
SaaS Application Configuration Guide : Mulesoft
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Mulesoft:
...
Mulesoft Configuration in AGC Workflow
----------------------------------------------
...
Mulesoft, select
Mulesoft and click on **Add** button
...
To configure Mulesoft provide following inputs:
	- **Sub-Domain** : Provide the sub-domain of your organization. For eg - <Domain>.anypoint.mulesoft.com
...
#. Identify the Saml SSO object created for for Mulesoft and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Mulesoft service.
