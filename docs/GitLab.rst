=================================================================
SaaS Application Configuration Guide : GitLab
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure GitLab:
...
GitLab Configuration in AGC Workflow
----------------------------------------------
...
GitLab, select
GitLab and click on **Add** button
...
GitLab does not require any user input.
...
#. Identify the Saml SSO object created for for GitLab and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in GitLab service.
