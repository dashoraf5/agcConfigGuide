=================================================================
SaaS Application Configuration Guide : AppDynamics
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure AppDynamics:
...
AppDynamics Configuration in AGC Workflow
----------------------------------------------
...
AppDynamics, select
AppDynamics and click on **Add** button
...
To configure AppDynamics provide following inputs:
...
#. Identify the Saml SSO object created for for AppDynamics and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in AppDynamics service.
