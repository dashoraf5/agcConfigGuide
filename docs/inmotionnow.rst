=================================================================
SaaS Application Configuration Guide : inmotionnow
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure inmotionnow:
...
inmotionnow Configuration in AGC Workflow
----------------------------------------------
...
inmotionnow, select
inmotionnow and click on **Add** button
...
To configure inmotionnow provide following inputs:
	- **EntityID** : Provide the entityID
	- **Sub Domain** : Provide the sub domain from the SSO URL. For eg if SSO URL is https://company.inmotionnow.com/saml/post, then the subDomain is company
...
#. Identify the Saml SSO object created for for inmotionnow and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in inmotionnow service.
