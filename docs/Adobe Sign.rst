=================================================================
SaaS Application Configuration Guide : Asobe Sign (formerly Echosign)
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Asobe Sign (formerly Echosign):
...
Asobe Sign (formerly Echosign) Configuration in AGC Workflow
----------------------------------------------
...
Asobe Sign (formerly Echosign), select
Asobe Sign (formerly Echosign) and click on **Add** button
...
To configure Asobe Sign (formerly Echosign) provide following inputs:
...
#. Identify the Saml SSO object created for for Asobe Sign (formerly Echosign) and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Asobe Sign (formerly Echosign) service.
