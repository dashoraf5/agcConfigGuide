=================================================================
SaaS Application Configuration Guide : Clarizen
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Clarizen:
...
Clarizen Configuration in AGC Workflow
----------------------------------------------
...
Clarizen, select
Clarizen and click on **Add** button
...
To configure Clarizen provide following inputs:
	- **Subdomain** : Provide the subDomain. For eg if the ACS URL is https://company.clarizen.com/Clarizen/Pages/Integrations/SAML/SamlResponse.aspx, the subDomain is company.
...
#. Identify the Saml SSO object created for for Clarizen and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Clarizen service.
