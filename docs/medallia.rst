...
To configure Medallia provide following inputs:
	- **Customer Id** : Specify Customer Id which is used along with domain to setup entityId, example https://<domain>.medallia.com/sso/<customerId>
	- **Medallia Domain** : Specify medallia domain which is used along with customerId to setup entityId, example https://<domain>.medallia.com/sso/<customerId>
