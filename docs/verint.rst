=================================================================
SaaS Application Configuration Guide : Verint
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Verint:
...
Verint Configuration in AGC Workflow
----------------------------------------------
...
Verint, select
Verint and click on **Add** button
...
To configure Verint provide following inputs:
	- **Subdomain** : Provide the subDomain. For eg if the SSO URL is https://company.verint.com, the subDomain is company.
...
#. Identify the Saml SSO object created for for Verint and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Verint service.
