=================================================================
SaaS Application Configuration Guide : Jive
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Jive:
...
Jive Configuration in AGC Workflow
----------------------------------------------
...
To configure Jive provide following inputs:
	- **Domain Name** : Provide your domain name where Jive is hosted.
...
#. Identify the Saml SSO object created for for Jive and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Jive service.
