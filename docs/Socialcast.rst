=================================================================
SaaS Application Configuration Guide : Socialcast
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Socialcast:
...
Socialcast Configuration in AGC Workflow
----------------------------------------------
...
Socialcast, select
Socialcast and click on **Add** button
...
To configure Socialcast provide following inputs:
	- **Sub-domain** : If your SSO url is https://company.socialcast.com, Sub-domain is company
...
#. Identify the Saml SSO object created for for Socialcast and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Socialcast service.
