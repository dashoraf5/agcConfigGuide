=================================================================
SaaS Application Configuration Guide : Lynda.com
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Lynda.com:
...
Lynda.com Configuration in AGC Workflow
----------------------------------------------
...
Lynda.com, select
Lynda.com and click on **Add** button
...
To configure Lynda.com provide following inputs:
	- **Subject Value** : Provide the session variable which correspoonds to the user id.
...
#. Identify the Saml SSO object created for for Lynda.com and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Lynda.com service.
