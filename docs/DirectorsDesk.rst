=================================================================
SaaS Application Configuration Guide : DirectorsDesk
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure DirectorsDesk:
...
To configure DirectorsDesk provide following inputs:
	- **Sub Domain** : Provide the sub domain. For eg - If the SSO URL is https://company.directorsdesk.com/saml2login.aspx, then the sub domain is company.
...
#. Identify the Saml SSO object created for for DirectorsDesk and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in DirectorsDesk service.
