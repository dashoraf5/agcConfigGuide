=================================================================
SaaS Application Configuration Guide : Brainshark
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Brainshark:
...
Brainshark Configuration in AGC Workflow
----------------------------------------------
...
Brainshark, select
Brainshark and click on **Add** button
...
To configure Brainshark provide following inputs:
	- **Environment** : Choose environment type. Environment type can be 'Production' or 'Staging'
	- **ACS URL** : Assertion Consumer Service URL. e.g. https://sso.brainshark.com/sp/ACS.saml2
...
#. Identify the Saml SSO object created for for Brainshark and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Brainshark service.
