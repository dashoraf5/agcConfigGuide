=================================================================
SaaS Application Configuration Guide : xmatters
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure xmatters:
...
xmatters Configuration in AGC Workflow
----------------------------------------------
...
xmatters, select
xmatters and click on **Add** button
...
To configure xmatters provide following inputs:
	- **Company Sub Domain name** : Sub Domain is used to in entityID example : https://acme.xmatters.com
...
#. Identify the Saml SSO object created for for xmatters and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in xmatters service.
