=================================================================
SaaS Application Configuration Guide : Janison Learning
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Janison Learning:
...
Janison Learning Configuration in AGC Workflow
----------------------------------------------
...
Janison Learning, select
Janison Learning and click on **Add** button
...
To configure Janison Learning provide following inputs:
	- **Sub Domain** : Specify Sub Domain, for example if your entityId is https://acme.cls.janison.com then your Sub Domain is acme
...
#. Identify the Saml SSO object created for for Janison Learning and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Janison Learning service.
