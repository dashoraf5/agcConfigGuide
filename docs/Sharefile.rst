=================================================================
SaaS Application Configuration Guide : Sharefile
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Sharefile:
...
Sharefile Configuration in AGC Workflow
----------------------------------------------
...
Sharefile, select
Sharefile and click on **Add** button
...
To configure Sharefile provide following inputs:
	- **SubDomain** : From the SSO URL like https://company.sharefile.com/saml/acs, sub Domain is company
...
#. Identify the Saml SSO object created for for Sharefile and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Sharefile service.
