=================================================================
SaaS Application Configuration Guide : Proxyclick
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Proxyclick:
...
Proxyclick Configuration in AGC Workflow
----------------------------------------------
...
Proxyclick, select
Proxyclick and click on **Add** button
...
To configure Proxyclick provide following inputs:
	- **Company ID** : Provide the company ID. Eg., https://saml.proxyclick.com/consume/companyID. Usually company starts with characters "CO".
...
#. Identify the Saml SSO object created for for Proxyclick and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Proxyclick service.
