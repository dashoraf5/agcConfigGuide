=================================================================
SaaS Application Configuration Guide : LinkedIn Learning
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure LinkedIn Learning:
...
LinkedIn Learning Configuration in AGC Workflow
----------------------------------------------
...
LinkedIn Learning, select
LinkedIn Learning and click on **Add** button
...
To configure LinkedIn Learning provide following inputs:
	- **EntityID** : Provide EntityID URL from the metadata file.
	- **Assertion Consumer Service URI** : Provide the Assertion Consumer Service URL from the metadata file.
...
#. Identify the Saml SSO object created for for LinkedIn Learning and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in LinkedIn Learning service.
