=================================================================
SaaS Application Configuration Guide : Greenhouse
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Greenhouse:
...
Greenhouse Configuration in AGC Workflow
----------------------------------------------
...
Greenhouse, select
Greenhouse and click on **Add** button
...
To configure Greenhouse provide following inputs:
	- **Subdomain** : Provide the subDomain. For eg if the ACS URL is https://company.greenhouse.io/users/saml/consume, the subDomain is company.
...
#. Identify the Saml SSO object created for for Greenhouse and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Greenhouse service.
