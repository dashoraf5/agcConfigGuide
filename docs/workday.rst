=================================================================
SaaS Application Configuration Guide : Workday
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Workday:
...
Workday Configuration in AGC Workflow
----------------------------------------------
...
Workday, select
Workday and click on **Add** button
...
To configure Workday provide following inputs:
	- **Tenant Name** : Provide your tenantName from the ACS uri. For eg - If the URI is https://company.workday.com/test/login-saml.htmld, then test is the tenant name.
	- **Domain Name** : Provide the domain name where workday is hosted.
...
#. Identify the Saml SSO object created for for Workday and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Workday service.
