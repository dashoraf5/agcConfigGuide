=================================================================
SaaS Application Configuration Guide : planview
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure planview:
...
planview Configuration in AGC Workflow
----------------------------------------------
...
planview, select
planview and click on **Add** button
...
To configure planview provide following inputs:
	- **Sub Domain** : Specify Sub Domain which is used to configure entityId, example https://acme.pvcloud.com/planview/
...
#. Identify the Saml SSO object created for for planview and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in planview service.
