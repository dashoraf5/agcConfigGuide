=================================================================
SaaS Application Configuration Guide : securitymentor
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure securitymentor:
...
securitymentor Configuration in AGC Workflow
----------------------------------------------
...
securitymentor, select
securitymentor and click on **Add** button
...
To configure securitymentor provide following inputs:
	- **Organization ID** : Provide the organization id.  For eg - If SSO URL is https://www.securitymentor.com/simplesaml/module.php/saml/sp/saml2-acs.php/company, then orgId is company.
...
#. Identify the Saml SSO object created for for securitymentor and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in securitymentor service.
