=================================================================
SaaS Application Configuration Guide : Thirdlight
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Thirdlight:
...
Thirdlight Configuration in AGC Workflow
----------------------------------------------
...
Thirdlight, select
Thirdlight and click on **Add** button
...
To configure Thirdlight provide following inputs:
	- **Sub-domain** : If your SSO URL is http://company.thirdlight.com/saml/sp, then sub domain is company.
	- **Unique Company Identifier** : From the ACS URL, https://$subDomain$.thirdlight.com/samlconsume.tlx/1234567890/module.php/saml/sp/saml2-acs.php/samlauth, then the Unique Company Identifier is 1234567890
...
#. Identify the Saml SSO object created for for Thirdlight and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Thirdlight service.
