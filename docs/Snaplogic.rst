=================================================================
SaaS Application Configuration Guide : Snaplogic
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Snaplogic:
...
Snaplogic Configuration in AGC Workflow
----------------------------------------------
...
Snaplogic, select
Snaplogic and click on **Add** button
...
To configure Snaplogic provide following inputs:
	- **EntityId** : Provide the entityID from the SAML metadata. It looks like - https://company.com/api/1/rest/admin/sso/login?org_path=company
	- **Assertion Consumer Service** : Provide the Assertion Consumer Service URI. It looks like - https://company.com/api/1/rest/admin/org/abcdyzoesks/saml/consume
...
#. Identify the Saml SSO object created for for Snaplogic and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Snaplogic service.
