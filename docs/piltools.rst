=================================================================
SaaS Application Configuration Guide : PILtools
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure PILtools:
...
PILtools Configuration in AGC Workflow
----------------------------------------------
...
PILtools, select
PILtools and click on **Add** button
...
To configure PILtools provide following inputs:
	- **Customer ID** : Specify Customer Id which is used to setup entityId, for example, https://stg.piltools.com/sso/<customerId>/
...
#. Identify the Saml SSO object created for for PILtools and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in PILtools service.
