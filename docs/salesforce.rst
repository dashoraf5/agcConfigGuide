=================================================================
SaaS Application Configuration Guide : Salesforce
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Salesforce:
...
Salesforce Configuration in AGC Workflow
----------------------------------------------
...
Salesforce, select
Salesforce and click on **Add** button
...
To configure Salesforce provide following inputs:
	- **Domain Specific ID** : Provide your domain specific unique id.
	- **Domain Name** : Provide the domain name for your salesforce application.
...
#. Identify the Saml SSO object created for for Salesforce and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Salesforce service.
