=================================================================
SaaS Application Configuration Guide : Cisco Meraki
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Cisco Meraki:
...
Cisco Meraki Configuration in AGC Workflow
----------------------------------------------
...
Cisco Meraki, select
Cisco Meraki and click on **Add** button
...
To configure Cisco Meraki provide following inputs:
	- **User Role** : Provide the session variable identifying the user's role. This must match the Role defined in Meraki Administrator page.
	- **Dashboard Username** : Provide the session variable identifying the user in the dashboard.
	- **Assertion Consumer Service URI** : Provide the Consumer URL from the Organization>Settings page under SAML Configuration on Meraki administrative console.
...
#. Identify the Saml SSO object created for for Cisco Meraki and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Cisco Meraki service.
