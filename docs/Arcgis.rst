=================================================================
SaaS Application Configuration Guide : Arcgis
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Arcgis:
...
Arcgis Configuration in AGC Workflow
----------------------------------------------
...
Arcgis, select
Arcgis and click on **Add** button
...
To configure Arcgis provide following inputs:
	- **Subdomain** : If your SSO URL is https://company.maps.arcgis.com/sharing/rest/oauth2/saml/signin, then subdomain is company.
	- **Subject Value** : Provide the subject Value (NameID for your app)
...
#. Identify the Saml SSO object created for for Arcgis and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Arcgis service.
