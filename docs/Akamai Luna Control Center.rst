...
To configure Akamai Luna Control Center provide following inputs:
	- **Company sub domain** : Provide your company sub-domain. For eg if your SSO URL is https://company.luna-sp.com/sso/endpoint/postResponse then sub-domain is company.
