=================================================================
SaaS Application Configuration Guide : ADP
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure ADP:
...
ADP Configuration in AGC Workflow
----------------------------------------------
...
To configure ADP provide following inputs:
	- **PersonImmutableID** : Provide the session variable which will map to the personimmutableID attribute. This attribute is sent to ADP in the assertion.
	- **Relay State** : The relay state can be an absolute path, such as /hr/index.html; it can be a URL, such as https://www.abc.com/index.html; or, it can be anything that the service provider understands.
...
#. Identify the Saml SSO object created for for ADP and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in ADP service.
