=================================================================
SaaS Application Configuration Guide : Kaltura
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Kaltura:
...
Kaltura Configuration in AGC Workflow
----------------------------------------------
...
Kaltura, select
Kaltura and click on **Add** button
...
To configure Kaltura provide following inputs:
	- **Sub Domain** : Provide the Sub Domain. For e.g. if the Entity Id URL is https://company.kaltura.com, the Sub Domain is company
...
#. Identify the Saml SSO object created for for Kaltura and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Kaltura service.
