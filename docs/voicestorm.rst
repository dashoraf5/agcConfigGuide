=================================================================
SaaS Application Configuration Guide : voicestorm
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure voicestorm:
...
voicestorm Configuration in AGC Workflow
----------------------------------------------
...
voicestorm, select
voicestorm and click on **Add** button
...
To configure voicestorm provide following inputs:
	- **Domain Name** : Specify domain name. For example, if your ACS URI is https://acme.voicestorm.com/User/SsoResponse, then enter acme. This will be used to also setup entityId https://acme.voicestorm.com
...
#. Identify the Saml SSO object created for for voicestorm and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in voicestorm service.
