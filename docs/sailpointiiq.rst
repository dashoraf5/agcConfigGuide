=================================================================
SaaS Application Configuration Guide : Sailpoint IIQ
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Sailpoint IIQ:
...
Sailpoint IIQ Configuration in AGC Workflow
----------------------------------------------
...
Sailpoint IIQ, select
Sailpoint IIQ and click on **Add** button
...
To configure Sailpoint IIQ provide following inputs:
	- **Sailpoin IIQ host** : Specify Sailpoint IIQ host which is used to setup entityId, example: https://sailpoint-host/idenitityiq
...
#. Identify the Saml SSO object created for for Sailpoint IIQ and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Sailpoint IIQ service.
